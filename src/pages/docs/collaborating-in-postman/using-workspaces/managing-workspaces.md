...
To see and edit your workspace details (e.g. name, description...), from the Postman app workspace selector, hover over a workspace, click **...**, and select **View Details**. You can also view the details and manage your workspaces from the [Workspaces dashboard](https://app.getpostman.com/dashboard).
...
You can access Public workspaces from the [**Workspace** category in the API Network](https://explore.postman.com/workspaces).
